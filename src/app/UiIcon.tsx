type UiIconName = 'library' | 'sparkles' | 'sets' | 'info' | 'music' | 'back' | 'close' | 'start' | 'heat' | 'drum' | 'high' | 'check'
        ...
        : name === 'info' ? <><circle cx="12" cy="12" r="9" /><path d="M12 11v5M12 8h.01" /></>
          : name === 'music' ? <><path d="M9 18V5l10-2v13" /><circle cx="6" cy="18" r="3" /><circle cx="16" cy="16" r="3" /></>
            : name === 'back' ? <path d="m15 18-6-6 6-6" />
              : name === 'start' ? <><circle cx="12" cy="12" r="9" /><path d="m10 8 6 4-6 4V8Z" /></>
                : name === 'heat' ? <path d="M12 22c4 0 7-3 7-7 0-3-2-5-3-7-1 3-3 4-4 5 0-4-2-7-5-9 1 4-2 7-2 11 0 4 3 7 7 7Z" />
                  : name === 'drum' ? <><path d="M4 7h16v9c0 2-4 4-8 4s-8-2-8-4V7Z" /><path d="M4 7c0-2 4-3 8-3s8 1 8 3-4 3-8 3-8-1-8-3ZM8 11v7M16 11v7" /></>
                    : name === 'high' ? <path d="M12 20V5m-6 6 6-6 6 6" />
                      : name === 'check' ? <path d="m7 12 3 3 7-7" />
